...
def test_header_source_pairing_creates_relationship():
    analyzer = _make_analyzer(
        functions={
            "src/utils.process": Node(
                id="src/utils.process",
                name="process",
                component_type="function",
                file_path="/repo/src/utils.cpp",
                relative_path="src/utils.cpp",
            ),
            "src/utils.declare": Node(
                id="src/utils.declare",
                name="declare",
                component_type="function",
                file_path="/repo/src/utils.h",
                relative_path="src/utils.h",
            ),
        },
        relationships=[
            CallRelationship(
                caller="src/utils.__file__",
                callee="utils.h",
                call_line=1,
                is_resolved=False,
    ...
    header_impl_rels = [
        r for r in analyzer.call_relationships if r.relationship_type == "header_impl"
    ]
    ...
    analyzer = _make_analyzer(
        functions={
            "algo.run": Node(
                ...
                name="run",
                component_type="function",
                file_path="/repo/algo.cpp",
                relative_path="algo.cpp",
            ),
            "algo.init": Node(
                id="algo.init",
                name="init",
                component_type="function",
                file_path="/repo/algo.hpp",
                relative_path="algo.hpp",
            ),
        },
        relationships=[
            CallRelationship(
                caller="algo.__file__",
                callee="algo.hpp",
                call_line=1,
                is_resolved=False,
                relationship_type="include",
    ...
    analyzer = _make_analyzer(
        functions={
            "utils.process": Node(
                ...
                name="process",
                component_type="function",
                file_path="/repo/utils.cpp",
                relative_path="utils.cpp",
            ),
            "utils.helper": Node(
                id="utils.helper",
                name="helper",
                component_type="function",
                file_path="/repo/utils.h",
                relative_path="utils.h",
            ),
        },
        relationships=[
            CallRelationship(
                caller="utils.__file__",
                callee="utils.h",
                call_line=1,
                is_resolved=False,
                relationship_type="include",
